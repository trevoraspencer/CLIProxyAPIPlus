...
func main() {
	...
	flag.BoolVar(&xaiOAuthLogin, "xai-oauth-login", false, "Login to xAI using OAuth")
	...
	} else if xaiOAuthLogin {
		// Handle xAI OAuth login
		cmd.DoXAIOAuthLogin(cfg, options)
